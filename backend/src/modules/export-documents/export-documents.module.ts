...
import { ExportDocumentsController, PortalExportDocumentsController } from './export-documents.controller';
...
@Module({
  ...
  providers: [ExportDocumentsService, DocumentProcessor, ExportDocumentApprovalListener],
