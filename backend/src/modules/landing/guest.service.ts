...
export class GuestService {
  ...
  async getSummary() {
    const [shipmentCount, inProgressShipments, completedShipments] =
      await Promise.all([
    ...
    return {
      shipments: {
        ...
        completionRate:
          shipmentCount > 0
            ? Math.round((completedShipments / shipmentCount) * 100)
            : 0,
      },
      partners: {
        total: partnerTotal,
      ...
      proformaInvoices: {
        ...
        completionRate:
          piTotal > 0 ? Math.round((scConfirmed / piTotal) * 100) : 0,
      },
    };
  }
  ...
  async getFeaturedProducts() {
    ...
    return [
      ...
      },
      {
        ...
        hsCode: '0801.32',
        imageUrl:
          'https://images.unsplash.com/photo-1509911595703-f44a30e9d60d?auto=format&fit=crop&q=80&w=800',
      },
    ];
  }
}
