...
export class CreatePartnerDto {
  ...
  @IsNumber({ allowNaN: false, allowInfinity: false }, { message: 'Hạn mức tín dụng (Credit Limit) phải là số' })
  ...
  @toOptionalNumber()
  @IsOptional()
  @IsNumber({ allowNaN: false, allowInfinity: false }, { message: 'Điểm chất lượng phải là số' })
  @Min(0, { message: 'Điểm chất lượng không được âm' })
  qualityScore?: number;

  @toOptionalNumber()
  @IsOptional()
  @IsNumber({ allowNaN: false, allowInfinity: false }, { message: 'Điểm giao hàng phải là số' })
  @Min(0, { message: 'Điểm giao hàng không được âm' })
  deliveryScore?: number;

  @toOptionalNumber()
  @IsOptional()
  @IsNumber({ allowNaN: false, allowInfinity: false }, { message: 'Điểm giá cả phải là số' })
  @Min(0, { message: 'Điểm giá cả không được âm' })
  priceScore?: number;

  @toOptionalNumber()
  @IsOptional()
  @IsNumber({ allowNaN: false, allowInfinity: false }, { message: 'Công nợ AP phải là số' })
  ...
  @IsOptional()
  @IsBoolean({ message: 'Trạng thái hoạt động (isActive) phải là kiểu boolean' })
  isActive?: boolean;
}