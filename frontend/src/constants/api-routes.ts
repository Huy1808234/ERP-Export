...
export const API_ROUTES = {
  ...
  PORTAL: {
    ...
    SUPPORT_TICKET_DETAIL: (_id: string) => `${API_PREFIX}/portal/support/tickets/${_id}`,
    SUPPORT_TICKET_MESSAGES: (_id: string) => `${API_PREFIX}/portal/support/tickets/${_id}/messages`,
    SUPPORT_TICKET_STATUS: (_id: string) => `${API_PREFIX}/portal/support/tickets/${_id}/status`,
