...
export type RoleName = (typeof STAFF_ROLES)[number];
...
export const DASHBOARD_ACCESS_RULES: DashboardAccessRule[] = [
  { path: '/dashboard/access-denied', label: 'Thông báo phân quyền', roles: ALL_STAFF },
...
export function normalizeRoleName(roleName?: string | null): RoleName | '' {
  ...
  return ROLE_ALIASES[normalized] || (STAFF_ROLES.includes(normalized as RoleName) ? normalized as RoleName : '');
}
